(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))o(i);new MutationObserver(i=>{for(const t of i)if(t.type==="childList")for(const a of t.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&o(a)}).observe(document,{childList:!0,subtree:!0});function n(i){const t={};return i.integrity&&(t.integrity=i.integrity),i.referrerPolicy&&(t.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?t.credentials="include":i.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function o(i){if(i.ep)return;i.ep=!0;const t=n(i);fetch(i.href,t)}})();class d{constructor(){this.tg=null,this.currentPage=this.detectCurrentPage(),this.init()}init(){window.Telegram?.WebApp?this.setupTelegramWebApp():window.addEventListener("load",()=>{setTimeout(()=>{this.setupTelegramWebApp()},100)})}setupTelegramWebApp(){this.tg=window.Telegram.WebApp,this.tg.ready(),this.tg.expand(),this.tg.disableVerticalSwipes(),this.tg.setHeaderColor("#000000"),this.setupUIBehavior(),this.updateTelegramHeader()}setupUIBehavior(){document.addEventListener("contextmenu",e=>{e.preventDefault()}),document.addEventListener("dragstart",e=>{e.preventDefault()}),document.addEventListener("selectstart",e=>{e.target.tagName!=="INPUT"&&e.target.tagName!=="TEXTAREA"&&e.preventDefault()})}detectCurrentPage(){const e=window.location.pathname;return new URLSearchParams(window.location.search),e.includes("category.html")?"categories":e.includes("product.html")?"product":"home"}updateTelegramHeader(){this.tg&&(this.currentPage==="home"?(this.tg.BackButton.hide(),this.tg.MainButton.hide()):(this.tg.MainButton.hide(),this.tg.BackButton.show(),this.tg.BackButton.offClick(),this.tg.BackButton.onClick(()=>{window.location.href="./"})))}}window.telegramWebApp=null;document.addEventListener("DOMContentLoaded",()=>{window.telegramWebApp=new d});class c{constructor(){this.reducedMotion=window.matchMedia("(prefers-reduced-motion: reduce)").matches,this.isMobile=this.detectMobile(),!(!this.isMobile||this.reducedMotion)&&this.init()}detectMobile(){return/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)||"ontouchstart"in window&&window.innerWidth<=1024}init(){this.addStyles(),this.setupScrollBehavior()}addStyles(){if(document.getElementById("bounce-scroll-styles"))return;const e=document.createElement("style");e.id="bounce-scroll-styles",e.textContent=`
    ...
    `,document.head.appendChild(e)}setupScrollBehavior(){document.documentElement.classList.add("bounce-enabled"),document.body.classList.add("bounce-enabled"),this.optimizeTouchBehavior()}setupModalBehavior(){}optimizeTouchBehavior(){let e=0;document.addEventListener("touchstart",i=>{e=Date.now()},{passive:!0}),document.addEventListener("touchend",i=>{Date.now()-e<150},{passive:!0});let n=!1,o;document.addEventListener("scroll",()=>{n||(document.body.classList.add("is-scrolling"),n=!0),clearTimeout(o),o=setTimeout(()=>{document.body.classList.remove("is-scrolling"),n=!1},150)},{passive:!0})}disableBounce(e){e&&e.classList.add("no-bounce")}enableBounce(e){e&&e.classList.remove("no-bounce")}disablePageBounce(){document.documentElement.classList.add("no-bounce"),document.body.classList.add("no-bounce")}enablePageBounce(){document.documentElement.classList.remove("no-bounce"),document.body.classList.remove("no-bounce")}destroy(){const e=document.getElementById("bounce-scroll-styles");e&&e.remove(),document.documentElement.classList.remove("bounce-enabled"),document.body.classList.remove("bounce-enabled","is-scrolling")}}document.addEventListener("DOMContentLoaded",()=>{window.self===window.top&&(window.bounceScroll=new c)});window.BounceScroll=c;const s={"adobe-creative-cloud":{id:"adobe-creative-cloud",title:"Adobe Creative Cloud",category:"Adobe",price:1e3,oldPrice:1500,discount:"-30%",priceUSDT:"на wallet 26.90 USDT",labels:["Гарантия","Лицензия","Нужен VPN"],labelColors:["orange","violet","blue"],images:["https://images.unsplash.com/photo-1561736778-92e52a7769ef?w=600&h=400&fit=crop&crop=center","https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=600&h=400&fit=crop&crop=center","https://images.unsplash.com/photo-1586281380349-632531db7ed4?w=600&h=400&fit=crop&crop=center","https://images.unsplash.com/photo-1504805572947-34fad45aed93?w=600&h=400&fit=crop&crop=center","https://images.unsplash.com/photo-1609921212029-bb5a28e60960?w=600&h=400&fit=crop&crop=center"],variants:[{id:"variant-1",name:"Аккаунт"},{id:"variant-2",name:"Подписка"},{id:"variant-3",name:"Ключ"}],periods:[{id:"period-week",name:"Неделя",price:300},{id:"period-1",name:"1 мес",price:1e3},{id:"period-3",name:"3 мес",price:2500,discount:"Выгода 17%"},{id:"period-12",name:"12 мес",price:8e3,discount:"Выгода 33%"}],editions:[{id:"edition-1",name:"Adobe Creative Cloud",price:1e3},{id:"edition-2",name:"Photoshop + Lightroom",price:1500},{id:"edition-3",name:"Deluxe",price:1990}],description:`Adobe Creative Cloud — это полный набор профессиональных приложений для творчества. 
    ...
    `},"mcafee-total-protection":{id:"mcafee-total-protection",title:"McAfee Total Protection",category:"Антивирусы",price:800,oldPrice:1100,discount:"-27%",priceUSDT:"на wallet 21.50 USDT",labels:["Лицензия","Гарантия"],labelColors:["violet","orange"],images:["https://images.unsplash.com/photo-1563013544-824ae1b704d3?w=600&h=400&fit=crop&crop=center","https://images.unsplash.com/photo-1614064641938-3bbee52942c7?w=600&h=400&fit=crop&crop=center","https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=600&h=400&fit=crop&crop=center"],variants:[{id:"variant-1",name:"Ключ"},{id:"variant-2",name:"Аккаунт"}],periods:[{id:"period-1",name:"1 год",price:800},{id:"period-2",name:"2 года",price:1400,discount:"Выгода 13%"},{id:"period-3",name:"3 года",price:1900,discount:"Выгода 21%"}],editions:[{id:"edition-1",name:"Antivirus",price:800},{id:"edition-2",name:"Internet Security",price:1100},{id:"edition-3",name:"Total Protection",price:1400}],description:"McAfee Total Protection — всесторонняя защита от вирусов, защита личности, безопасный VPN и менеджер паролей. Защищает неограниченное количество устройств.",systemRequirements:`
      ...
      • Интернет-соединение для обновлений
         `}};function p(r){return s[r]||null}function l(){return Object.values(s)}function m(r){return Object.values(s).filter(e=>e.category===r)}function u(r,e="₽"){const n=r.toString();let o="";for(let i=n.length-1,t=0;i>=0;i--,t++)t>0&&t%3===0&&(o=" "+o),o=n[i]+o;return`<span class="formatted-price">${o}<span class="currency-separator">${e}</span></span>`}function h(r,e="₽"){return`${r}${e}`}function b(r,e="₽",n=!1){const o=r.toString();let i="";for(let t=o.length-1,a=0;t>=0;t--,a++)a>0&&a%3===0&&(i=" "+i),i=o[t]+i;return n?`<span class="formatted-price"><span style="text-decoration: line-through;">${i}</span><span class="currency-separator">${e}</span></span>`:`<span class="formatted-price">${i}<span class="currency-separator">${e}</span></span>`}const g=[{id:"banner-1",title:"Скидки до 70%",subtitle:"На популярные товары",category:"Игры",action:"category",actionParams:{category:"Игры"},backgroundColor:"#6366f1",active:!0},{id:"banner-2",title:"Хиты продаж",subtitle:"Самые покупаемые товары",category:"Игры",action:"category",actionParams:{category:"Игры"},backgroundColor:"#ef4444",active:!1},{id:"banner-3",title:"Подписки",subtitle:"Выгодные предложения",category:"Подписки",action:"category",actionParams:{category:"Подписки"},backgroundColor:"#06b6d4",active:!1},{id:"banner-4",title:"Специальное предложение",subtitle:"Ограниченное время",category:"Adobe",action:"category",actionParams:{category:"Adobe"},backgroundColor:"#f59e0b",active:!1}],f={Adobe:{name:"Adobe",description:"Профессиональные инструменты для дизайна и творчества",image:"https://images.unsplash.com/photo-1611224923853-80b023f02d71?w=400&h=300&fit=crop&crop=center"},Нейросети:{name:"Нейросети",description:"Искусственный интеллект и нейронные сети",image:"https://images.unsplash.com/photo-1677442136019-21780ecad995?w=400&h=300&fit=crop&crop=center"},Игры:{name:"Игры",description:"Лучшие игры для PC и консолей",image:"https://images.unsplash.com/photo-1552820728-8b83bb6b773f?w=400&h=300&fit=crop&crop=center"},Подписки:{name:"Подписки",description:"Подписки на сервисы и программы",image:"https://images.unsplash.com/photo-1586281380349-632531db7ed4?w=400&h=300&fit=crop&crop=center"},Антивирусы:{name:"Антивирусы",description:"Защита компьютера и данных",image:"https://images.unsplash.com/photo-1563013544-824ae1b704d3?w=400&h=300&fit=crop&crop=center"}};export{u as a,g as b,f as c,m as d,p as e,b as f,l as g,h};
