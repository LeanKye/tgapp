class c{constructor(){this.reducedMotion=window.matchMedia("(prefers-reduced-motion: reduce)").matches,this.isMobile=this.detectMobile(),!(!this.isMobile||this.reducedMotion)&&this.init()}detectMobile(){return/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)||"ontouchstart"in window&&window.innerWidth<=1024}init(){this.addStyles(),this.setupScrollBehavior()}addStyles(){if(document.getElementById("bounce-scroll-styles"))return;const e=document.createElement("style");e.id="bounce-scroll-styles",e.textContent=`
    ...
    `},"mcafee-total-protection":{id:"mcafee-total-protection",title:"McAfee Total Protection",category:"Антивирусы",price:800,oldPrice:1100,discount:"-27%",priceUSDT:"на wallet 21.50 USDT",labels:["Лицензия","Гарантия"],labelColors:["violet","orange"],images:["https://images.unsplash.com/photo-1563013544-824ae1b704d3?w=600&h=400&fit=crop&crop=center","https://images.unsplash.com/photo-1614064641938-3bbee52942c7?w=600&h=400&fit=crop&crop=center","https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=600&h=400&fit=crop&crop=center"],variants:[{id:"variant-1",name:"Ключ"},{id:"variant-2",name:"Аккаунт"}],periods:[{id:"period-1",name:"1 год",price:800},{id:"period-2",name:"2 года",price:1400,discount:"Выгода 13%"},{id:"period-3",name:"3 года",price:1900,discount:"Выгода 21%"}],editions:[{id:"edition-1",name:"Antivirus",price:800},{id:"edition-2",name:"Internet Security",price:1100},{id:"edition-3",name:"Total Protection",price:1400}],description:"McAfee Total Protection — всесторонняя защита от вирусов, защита личности, безопасный VPN и менеджер паролей. Защищает неограниченное количество устройств.",systemRequirements:`
      ...
      • Интернет-соединение для обновлений
         `}};function d(o){return s[o]||null}function p(){return Object.values(s)}function l(o){return Object.values(s).filter(e=>e.category===o)}function m(o,e="₽"){const r=o.toString();let t="";for(let i=r.length-1,a=0;i>=0;i--,a++)a>0&&a%3===0&&(t=" "+t),t=r[i]+t;return`<span class="formatted-price">${t}<span class="currency-separator">${e}</span></span>`}function u(o,e="₽"){return`${o}${e}`}function h(o,e="₽",r=!1){const t=o.toString();let i="";for(let a=t.length-1,n=0;a>=0;a--,n++)n>0&&n%3===0&&(i=" "+i),i=t[a]+i;return r?`<span class="formatted-price"><span style="text-decoration: line-through;">${i}</span><span class="currency-separator">${e}</span></span>`:`<span class="formatted-price">${i}<span class="currency-separator">${e}</span></span>`}const b=[{id:"banner-1",title:"Скидки до 70%",subtitle:"На популярные товары",category:"Игры",action:"category",actionParams:{category:"Игры"},backgroundColor:"#6366f1",active:!0},{id:"banner-2",title:"Хиты продаж",subtitle:"Самые покупаемые товары",category:"Игры",action:"category",actionParams:{category:"Игры"},backgroundColor:"#ef4444",active:!1},{id:"banner-3",title:"Подписки",subtitle:"Выгодные предложения",category:"Подписки",action:"category",actionParams:{category:"Подписки"},backgroundColor:"#06b6d4",active:!1},{id:"banner-4",title:"Специальное предложение",subtitle:"Ограниченное время",category:"Adobe",action:"category",actionParams:{category:"Adobe"},backgroundColor:"#f59e0b",active:!1}],g={Adobe:{name:"Adobe",description:"Профессиональные инструменты для дизайна и творчества",image:"https://images.unsplash.com/photo-1611224923853-80b023f02d71?w=400&h=300&fit=crop&crop=center"},Нейросети:{name:"Нейросети",description:"Искусственный интеллект и нейронные сети",image:"https://images.unsplash.com/photo-1677442136019-21780ecad995?w=400&h=300&fit=crop&crop=center"},Игры:{name:"Игры",description:"Лучшие игры для PC и консолей",image:"https://images.unsplash.com/photo-1552820728-8b83bb6b773f?w=400&h=300&fit=crop&crop=center"},Подписки:{name:"Подписки",description:"Подписки на сервисы и программы",image:"https://images.unsplash.com/photo-1586281380349-632531db7ed4?w=400&h=300&fit=crop&crop=center"},Антивирусы:{name:"Антивирусы",description:"Защита компьютера и данных",image:"https://images.unsplash.com/photo-1563013544-824ae1b704d3?w=400&h=300&fit=crop&crop=center"}};export{m as a,b,g as c,l as d,d as e,h as f,p as g,u as h};
